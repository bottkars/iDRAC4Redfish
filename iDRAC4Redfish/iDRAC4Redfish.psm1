...
{
 $outputobject = (invoke-WebRequest -ContentType 'application/json;charset=utf-8' -Uri ($global:IDRAC_schemas | where name -Match Manager).URL -Verbose -Credential $credentials).content | ConvertFrom-Json
