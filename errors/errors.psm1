...
Function Get-iDRACWebException
    {
    [CmdletBinding()]
    [OutputType([int])]
    Param
    (
        ...
        switch -Wildcard ($ExceptionMessage.FullyQualifiedErrorId)
            ...
            "*System.UriFormatException,Microsoft.PowerShell.Commands.Invoke*Command*"
                ...
                write-Host "Most likely you are not connected to the iDRAC System"
                write-Host "please use Connect-iDRAC or New-iDRACSession to connect and login to iDRAC"
                }
